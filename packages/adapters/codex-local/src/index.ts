...
- modelReasoningEffort (string, optional): reasoning effort override (minimal|low|medium|high|xhigh; gpt-6-astra also supports max) passed via -c model_reasoning_effort=...
